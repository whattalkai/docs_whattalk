...
icon: "credit-card"
description: "Learn how WhatTalk.ai billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

WhatTalk.ai operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Beyond 30 seconds, WhatTalk.ai bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
...
- Or proceed to [AI Assistants Overview](/ai-assistants/what-is-ai-assistant) to build your first assistant.
