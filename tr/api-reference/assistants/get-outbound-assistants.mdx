...
Bu uç nokta, kimliği doğrulanmış kullanıcıya ait tüm giden arama asistanlarının listesini döndürür. Giden arama asistanları, potansiyel müşterilere ve adaylara arama yapmak için kullanılır.
