...
api: "POST /user/lead"
description: "WhatTalk sisteminde yeni bir müşteri oluşturun"
---

Bu endpoint, WhatTalk sisteminde yeni bir müşteri oluşturmanızı sağlar.
...
<ParamField body="campaign_id" type="integer" required>
  Müşterinin oluşturulacağı kampanyanın kimliği
</ParamField>

<ParamField body="variables" type="object">
  Müşteriye aktarılacak özel değişkenler. **Asistanınızda tanımlı olan herhangi bir değişkeni** ekleyebilirsiniz (bkz. [Arama değişkenleri](/ai-assistants/settings/prompt-and-tools#call-variables)). Aşağıdaki örnekler yalnızca gösterim amaçlıdır — asistan ayarlarında yapılandırdığınız kendi değişken adlarınızı kullanın.
...
<ParamField body="allow_dupplicate" type="boolean">
  Bir kampanyada mükerrer müşterilere izin verilip verilmeyeceği.
</ParamField>

<ParamField body="secondary_contacts" type="array">
  Ana müşteriyle birlikte oluşturulacak ikincil iletişim kişileri dizisi
...
<ResponseField name="data" type="object">
  Müşteri veri nesnesi
  
  <Expandable title="veri özellikleri">
    <ResponseField name="id" type="integer">
      Oluşturulan müşterinin benzersiz kimliği
    </ResponseField>
    ...
    <ResponseField name="created_at" type="string">
      Müşterinin oluşturulma zaman damgası
    </ResponseField>
    
    <ResponseField name="updated_at" type="string">
      Müşterinin son güncellenme zaman damgası
    </ResponseField>
