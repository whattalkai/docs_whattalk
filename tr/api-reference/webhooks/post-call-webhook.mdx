...
<ResponseField name="lead" type="object">
  ...
  <Expandable title="Müşteri özellikleri">
    <ResponseField name="id" type="integer">
      Müşterinin benzersiz tanımlayıcısı
    </ResponseField>
    ...
    <ResponseField name="call_tries" type="integer">
      Bu müşteriye yapılan arama denemesi sayısı
    </ResponseField>
    <ResponseField name="created_at" type="string">
      Müşterinin oluşturulma tarihi
    </ResponseField>
    <ResponseField name="updated_at" type="string">
      Müşterinin son güncellenme tarihi
    </ResponseField>
    <ResponseField name="campaign" type="object">
      ...
      <Expandable title="Kampanya özellikleri">
        ...
        <ResponseField name="max_retries" type="integer">
          Müşteriler için maksimum yeniden deneme sayısı
        </ResponseField>
