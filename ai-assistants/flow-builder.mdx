...
- **Settings panel** - Configure assistant personality and behavior
...
- **Assistant Name** - The name your AI will use
- **Assistant Type** - Sales, Support, Survey, etc.
...
- **Transfer Assistant** - Hand off to another assistant
...
| Setting | Description |
|---------|-------------|
| **Assistant Name** | Name the AI uses to introduce itself |
| **Assistant Type** | Preset personality: Sales, Support, Survey, etc. |
